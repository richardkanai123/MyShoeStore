            ...
            <div className="w-full flex flex-col">
                    ...
                    {sizes.map((size) =>
                        <Button
                            ...
                            name='sizebutton' className={
                                searchParams.get('size') == parseInt(size) ? cn('bg-sky-400 hover:bg-slate-300') : ('hover:bg-sky-300')
                            } size='icon' key={size}>
                            {size}
                        </Button>)
                    }
                ...
                <div className="flex gap-2 w-full items-center align-middle flex-wrap mb-3">
                    {colors.map((color) => <Button
                        ...
                        className={searchParams.get('color') === color ? cn('bg-sky-400 hover:bg-slate-300') : ('hover:bg-sky-300')}
                        key={color}>{color}</Button>)
                    }
                </div>

                <p className="p-2 w-full text-base pointer-events-none font-normal md:w-3/4">
                ...
                <Button
                    onClick={() => {
                        console.log(searchParams.get('size'), searchParams.get('color'), searchParams.get('q'))
                    }}
