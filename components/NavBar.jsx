...
const NavBar = () => {
    ...
    return (
        <nav className=" z-40 sticky top-0 mx-auto flex flex-row justify-between w-full px-4 py-2 items-center bg-transparent rounded-b-lg text-xl font-semibold align-middle border-b snap-proximity shadow-md">
